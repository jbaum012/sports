        ...
        <b-card>
          <b-row class="align-items-center mb-2">
            <b-col sm="12" md="3" class="d-flex">
              <user-card :user="user" size="lg" variant="icon" class="mx-right"></user-card>
            </b-col>
              ...
              <b-tbody>
                <b-tr>
                  <b-td
                    ...
                    v-b-tooltip.right
                    :title="'Number of times ' + user.name + ' was the only won to win a bet'"
                  >Lone Wolf:</b-td>
                ...
                <b-tr>
                  <b-td
                    class="text-right w-50 align-middle"
                    v-b-tooltip.right
                    :title="'Number of times ' + user.name + ' was the only won to lose a bet'"
                  >Loan Wolf:</b-td>
                ...
                <b-tr>
                  <b-td
                    class="text-right w-50 align-middle"
                    v-b-tooltip.right
                    :title="'Number of times ' + user.name + '\'s pick won the game but lost the spread'"
                  >Dicked:</b-td>
                ...
                <b-tr>
                  <b-td
                    class="text-right w-50 align-middle"
                    v-b-tooltip.right
                    :title="'Number of times ' + user.name + '\'s pick lost the game but won the spread'"
                  >200 IQ play:</b-td>
                ...
                <b-tr>
                  <b-td
                    class="text-right w-50 align-middle"
                    v-b-tooltip.right
                    :title="'Number of times ' + user.name + ' successfully doubled down'"
                  >Double Do:</b-td>
                ...
                <b-tr>
                  <b-td
                    class="text-right w-50 align-middle"
                    v-b-tooltip.right
                    :title="'Number of times ' + user.name + ' unsuccessfully doubled down'"
                  >Double Don't:</b-td>
                ...
                <b-tr>
                  ...
                  <b-td class="text-left w-50 align-middle">
                    <team-card v-if="user.strong_arm !== null" :team="user.strong_arm"></team-card>
                  </b-td>
                </b-tr>
                <b-tr>
                  <b-td
                  ...
                  >Limp Dick:</b-td>
                  <b-td class="text-left w-50 align-middle">
                    <team-card v-if="user.limp_dick !== null" :team="user.limp_dick"></team-card>
                  </b-td>
                </b-tr>
                <b-tr>
                  <b-td
                  ...
                  >Favorite Team:</b-td>
                  <b-td class="text-left w-50 align-middle">
                    <team-card v-if="user.favorite_team !== null" :team="user.favorite_team"></team-card>
                  </b-td>
                </b-tr>
                <b-tr>
                  <b-td
                  ...
                  >BE GONE:</b-td>
                  <b-td class="text-left w-50 align-middle">
                    <team-card v-if="user.be_gone !== null" :team="user.be_gone"></team-card>
                  </b-td>
                </b-tr>
                <b-tr>
                  <b-td
