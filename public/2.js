...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  beforeMount: function beforeMount() {
    ...
    if (this.gameId) {
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("/api/games/".concat(this.gameId)).then(function (r) {
        _this.game = r.data;
        _this.date = _this.game.starts_at;
      });
    }
  }
});
...
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_BettingCard_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/BettingCard.vue */ "./resources/js/components/BettingCard.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    BettingCard: _components_BettingCard_vue__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  props: {
    week: {
      type: Number,
  ...
  methods: {
    ...
    submitBet: function submitBet(team) {
  ...
  return _c("tr", [
    _c(
      ...
      [
        _vm.game.user_bet
          ? _c("team-card", {
              attrs: { team: _vm.game.user_bet.team },
              on: { click: _vm.doubleDown }
            })
          : _c("span", [_vm._v("-")])
      ],
      1
    ...
    _c(
      ...
      [
        ...
        _c(
          "b-modal",
          { attrs: { id: _vm.gameModalId, title: "Game" } },
          [_c("game-form", { attrs: { "game-id": _vm.game.id } })],
          1
        )
      ],
      1
          ...
          _c(
            ...
            [
              ...
              _c("b-form-datepicker", {
                ...
                attrs: { id: "date" },
                model: {
                  value: _vm.game.starts_at,
                  callback: function($$v) {
                    _vm.$set(_vm.game, "starts_at", $$v)
                  },
                  expression: "game.starts_at"
                }
              })
            ],
            1
...
var render = function() {
  ...
  return _c(
    ...
    [_vm._v(_vm._s(_vm.team.nickname))]
  )
}
var staticRenderFns = []
render._withStripped = true
    ...
    _c("table", { staticClass: "table" }, [
      ...
      _c(
        ...
        _vm._l(_vm.games, function(game) {
          return _c("betting-card", { key: game.id, attrs: { game: game } })
        }),
        1
      )
    ])
