  ...
  methods: _objectSpread({
    fetchData: function fetchData() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get("/api/week/".concat(this.week, "/games")).then(function (r) {
        return _this.gamesThisWeek = r.data;
      });
    },
    ...
    weekDisplay: function weekDisplay(week) {
      return moment__WEBPACK_IMPORTED_MODULE_4___default.a.utc(week).format('dddd, MMM Do h:mm a');
    }
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "d-flex flex-grow", style: _vm.cardStyle }, [
    _c(
      "div",
      {
    ...
    _vm.score !== null
      ? _c(
          "div",
          { staticClass: "d-flex align-items-center p-2 bg-white h4 mb-0" },
          [_vm._v("\n    " + _vm._s(_vm.score) + "\n  ")]
        )
      : _vm._e()
  ])
